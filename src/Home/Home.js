                ...
                <div className = "container">
                    ...
                    <div className ="row">
                        <div className ="col-12 col-md-8 container">
                            ...
                            <div >
                                <img className ="concierto"src="https://firebasestorage.googleapis.com/v0/b/spotyllp.appspot.com/o/concert.jpg?alt=media&token=b64034ac-499a-4b21-a0aa-b487af59cf45" alt="concierto"/>
                            </div>
                        </div>

                        <div className ="col-12 col-md-4 border-start align-self-center text-black p-5 border border-white">
                            <div className ="row">
                ...
                <div className ="row">
                    ...
                    <div className ="row">
                        <div className ="col-12 col-md-4">
                            <img src="https://firebasestorage.googleapis.com/v0/b/spotyllp.appspot.com/o/noticia1.webp?alt=media&token=43bca0e2-45fc-4559-b06c-ca01860679ef" alt="" className ="img-fluid w-100 noticia"></img>
                        ...
                        <div className ="col-12 col-md-4">
                            <img src="https://firebasestorage.googleapis.com/v0/b/spotyllp.appspot.com/o/noticia4.jpg?alt=media&token=629c51fc-1335-4145-b6d1-862af6b3006a" alt="" className ="img-fluid w-100 noticia"></img>
                        ...
                        <div className ="col-12 col-md-4">
                            <img src="https://firebasestorage.googleapis.com/v0/b/cinemaleiderlucas.appspot.com/o/not4.jpg?alt=media&token=a3a32e99-e3df-423b-93d5-242e80b12c46" alt="" className ="img-fluid w-100 noticia"></img>
